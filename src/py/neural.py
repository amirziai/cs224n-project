...
class NeuralModel(object):
    ...
    @staticmethod
    def _append_to_csv(file_name, it, cur_lr, total_nll, dev_nll, time_elapsed):
        with open(file_name, 'a') as f:
            f.write('{it}, {cur_lr}, {total_nll}, {dev_nll}, {time_elapsed}\n'.format(it=it,
                                                                                      cur_lr=cur_lr,
                                                                                      total_nll=total_nll,
                                                                                      dev_nll=dev_nll,
    ...
    def train(self, dataset, eta=0.1, T=[], verbose=False, dev_data=None,
              ...
              concat_num=1, concat_prob=0.0, augmenter=None, aug_frac=0.0, file_name=''):
        ...
        for it in range(max_iters):
            ...
            self._append_to_csv(file_name, it, cur_lr, total_nll, dev_nll, time_elapsed)
